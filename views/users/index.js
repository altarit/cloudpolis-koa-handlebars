...
exports.detail = function *(next) {
  ...
  //if (err) return next(new HttpError(500, "ќшибка в /users/-id/index.js"));
  if (user) {
    yield this.render('users/detail.html', {locals: this.locals, profile: user});
  } else {
    throw new HttpError(404, "ёзер не найден.");
  }
};
...
exports.update = function *(next) {
  ...
  //if(err) return next(new HttpError(500, 'ќшибка в /views/posts/-id/index.js'));
